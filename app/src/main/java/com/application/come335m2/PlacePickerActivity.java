...
public class PlacePickerActivity extends Activity
            ...
            if (mLastLocation != null) {
                ...
                stpCall.enqueue(new Callback<FoursquareJSON>() {
                    ...
                    public void onResponse(Call<FoursquareJSON> call, Response<FoursquareJSON> response) {
                        ...
                        snapToPlace.setText("Şu an " + fv.name + " buraya yakınsın.");
                    }
                    @Override
                    public void onFailure(Call<FoursquareJSON> call, Throwable t) {
                        Toast.makeText(getApplicationContext(), "Foursquare serverına ulaşılamıyor!", Toast.LENGTH_LONG).show();
                        finish();
                    }
                });
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(getApplicationContext(), "Googler serverına ulaşılamıyor!", Toast.LENGTH_LONG).show();
        finish();
    }
}